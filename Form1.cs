...
{
    public partial class WAR_AT_SEA : Form
    {
        ...
        private void EnemyPlayTimerEvent(object sender, EventArgs e)
        {
            ...
            if(round < 1 || enemyScore > 2 || playerScore > 2)
            {
                ...
                {
                    MessageBox.Show("I SUNK YOUR SHIP!", "Winner");
                    RestartGame();
                }
                else if (enemyScore == playerScore){
                    MessageBox.Show("NO WINNER ON THIS GAME", "Winner");
                    RestartGame();
                }
            }
        ...
        private void AttackButtonEvent(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Choose a location from drop down first", "İnformation");
            }
        }
        ...
        private void PlayerPositionButtonsEvent(object sender, EventArgs e)
        {
            ...
            if (totalShips == 0)
            {
                ...
                txtHelp.Text = "Pick the attack positions from the drop down";
            }
        }
        ...
        private void RestartGame()
        {
            ...
            txtHelp.Text = "Click on 3 different locations from above to start!";
